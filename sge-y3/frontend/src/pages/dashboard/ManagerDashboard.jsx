...
import Evaluermonequipe from "@/pages/manager/Evaluermonequipe";
import Objectifsequipe from "@/pages/manager/Objectifsequipe";
import Monautoevaluation from "@/pages/manager/Monautoevaluation";
import Monhistorique from "@/pages/manager/Monhistorique";
import HistoriqueEquipe from "@/pages/manager/HistoriqueEquipe";
import Rapportsequipe from "@/pages/manager/Rapportsequipe";
