...
import TableauRH from "@/pages/rh/TableauRH";
import ValidationsRH from "@/pages/rh/ValidationsRH";
import MonautoevaluationAssistanteRH from "@/pages/rh/MonautoevaluationAssistanteRH";
import MonautoevaluationRH from "@/pages/rh/MonautoevaluationRH";
import QuestionnaireRH from "@/pages/rh/QuestionnaireRH";
import SynthesesRH from "@/pages/rh/SynthesesRH";
import CalibrationRH from "@/pages/rh/CalibrationRH";
import EvaluationsDepartementRH from "@/pages/rh/EvaluationsDepartementRH";
import PopulationRH from "@/pages/rh/PopulationRH";
import RapportsRH from "@/pages/rh/RapportsRH";
import EvaluationAssistanteRH from "@/pages/rh/EvaluationAssistanteRH";
import Monhistorique from "@/pages/rh/Monhistorique";
import HistoriqueEquipe from "@/pages/rh/HistoriqueEquipe";
import GestionCycles from "@/pages/rh/GestionCycles";
import GestionCollaborateurs from "@/pages/rh/GestionCollaborateurs";
import CommentairesAnonymesRH from "@/pages/rh/CommentairesAnonymesRH";
